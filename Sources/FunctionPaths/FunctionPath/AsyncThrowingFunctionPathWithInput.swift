...
///
/// ``AsyncThrowingFuncPathWithInput`` is available as an alias.
///
@dynamicMemberLookup
public struct AsyncThrowingFunctionPathWithInput<Root, Return> {
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using another `FunctionPath`.
    ///
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using another `ThrowingFunctionPath`.
    ///
    /// This method allows for the composition of two function paths, effectively chaining their behavior.
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using another `AsyncFunctionPath`.
    ///
    /// This method allows for the composition of two function paths, effectively chaining their behavior.
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using another `AsyncThrowingFunctionPath`.
    ///
    /// This method allows for the composition of two function paths, effectively chaining their behavior.
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using another `FunctionPathWithInput`.
    ///
    /// This method allows for the composition of two function paths, effectively chaining their behavior.
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using another `ThrowingFunctionPathWithInput`.
    ///
    /// This method allows for the composition of two function paths, effectively chaining their behavior.
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using another `AsyncFunctionPathWithInput`.
    ///
    /// This method allows for the composition of two function paths, effectively chaining their behavior.
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using another `AsyncThrowingFunctionPathWithInput`.
    ///
    /// This method allows for the composition of two function paths, effectively chaining their behavior.
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using a `KeyPath`.
    ///
    ...
    /// Appends a transformation to the current `AsyncThrowingFunctionPathWithInput` using a `KeyPath`.
    ///
    /// This version of the `appending` method creates a new `AsyncThrowingFunctionPathWithInput` instance, extending the original function's behavior by applying the specified `KeyPath`.
    ///
    /// - Parameter keyPath: A `KeyPath` from the `Return` type of the current function path to the desired `AppendedReturn` type.
    ///   This keyPath specifies the property to be extracted or transformed from the `Return` type.
    ///
    /// - Returns: A new `AsyncThrowingFunctionPathWithInput<Root, AppendedReturn>` instance.
