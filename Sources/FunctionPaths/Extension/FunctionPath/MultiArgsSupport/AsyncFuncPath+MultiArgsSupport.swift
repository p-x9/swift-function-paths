//
//  AsyncFuncPath+MultiArgsSupport.swift
//  
//
...
/// ) -> (Root) async -> Return where Input == (repeat each T){
///     { root in
///         let inputs = (repeat (each input)())
///         return await call(root)(inputs) // ❌
///     }
/// }
///```
extension AsyncFunctionPath {
    ...
    ) -> (Root) async -> Return where Input == (In1, In2) {
        { root in
            await call(root)((arg1(), arg2()))
        }
    }
    ...
    public func callAsFunction<In1, In2>(
        _ arg1: @escaping @autoclosure () -> In1,
        _ arg2: @escaping @autoclosure () -> In2
    ) -> AsyncFunctionPathWithInput<Root, Return> where Input == (In1, In2) {
        .init(
            call: call,
            input: (arg1(), arg2())
        )
    ...
    ) -> (Root) async -> Return where Input == (In1, In2, In3) {
        { root in
            await call(root)((arg1(), arg2(), arg3()))
        }
    }
    ...
    public func callAsFunction<In1, In2, In3>(
        ...
        _ arg2: @escaping @autoclosure () -> In2,
        _ arg3: @escaping @autoclosure () -> In3
    ) -> AsyncFunctionPathWithInput<Root, Return> where Input == (In1, In2, In3) {
        .init(
            call: call,
    ...
    ) -> (Root) async -> Return where Input == (In1, In2, In3, In4) {
        { root in
            await call(root)((arg1(), arg2(), arg3(), arg4()))
        }
    }
    ...
    public func callAsFunction<In1, In2, In3, In4>(
        ...
        _ arg3: @escaping @autoclosure () -> In3,
        _ arg4: @escaping @autoclosure () -> In4
    ) -> AsyncFunctionPathWithInput<Root, Return> where Input == (In1, In2, In3, In4) {
        .init(
            call: call,
    ...
    ) -> (Root) async -> Return where Input == (In1, In2, In3, In4, In5) {
        { root in
            await call(root)((arg1(), arg2(), arg3(), arg4(), arg5()))
        }
    }
    ...
    public func callAsFunction<In1, In2, In3, In4, In5>(
        ...
        _ arg4: @escaping @autoclosure () -> In4,
        _ arg5: @escaping @autoclosure () -> In5
    ) -> AsyncFunctionPathWithInput<Root, Return> where Input == (In1, In2, In3, In4, In5) {
        .init(
            call: call,
